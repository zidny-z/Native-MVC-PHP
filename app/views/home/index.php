		...
		<section class="section-divider textdivider divider3">
			<div class="container">
				<h1 class="fade-down">تَعَلَّمُوْاوَعَلِّمُوْاوَتَوَاضَعُوْالِمُعَلِّمِيْكُمْ وَلَيَلَوْا لِمُعَلِّمِيْكُمْ ( رَواهُ الطَّبْرَانِيْ)</h1>
				<hr>
					...
					<div class="fade-up col-md-4 ">
				    	<div class="grid mask">
							<figure>
								...
								<figcaption>
									<h5>PEDULI BANGSA</h5>
									<a href="" class="btn btn-primary btn-lg"><i class="el-icon-link"></i></a>
		...
		<section class="section-divider textdivider divider6">
			<div class="container">
				<h1 class="fade-down">ADA UNTUK INDONESIA.</h1>
				<hr>
				<div class="fade-up">
